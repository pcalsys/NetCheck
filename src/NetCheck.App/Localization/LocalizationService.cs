...
public sealed partial class LocalizationService : ObservableObject, ITextLocalizer
{
    ...
    private static readonly ReadOnlyDictionary<string, string> GermanTranslations =
        new(new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Ready to measure your connection"] = "Bereit, Ihre Verbindung zu messen",
            ["Preparing the speed test…"] = "Speedtest wird vorbereitet…",
            ["Measuring latency…"] = "Latenz wird gemessen…",
            ["Measuring download speed…"] = "Downloadgeschwindigkeit wird gemessen…",
            ["Measuring upload speed…"] = "Uploadgeschwindigkeit wird gemessen…",
            ["Speed test complete"] = "Speedtest abgeschlossen",
            ["Speed test completed"] = "Speedtest abgeschlossen",
            ["SPEED TEST"] = "SPEEDTEST",
            ["SETTINGS"] = "EINSTELLUNGEN",
            ["DIAGNOSIS"] = "DIAGNOSE",
            ["Settings changed"] = "Einstellungen geändert",
            ["Language changed"] = "Sprache geändert",
            ["{0} download · {1} upload · {2} latency"] = "{0} Download · {1} Upload · {2} Latenz",
            ["1 setting changed"] = "1 Einstellung geändert",
            ["{0} settings changed"] = "{0} Einstellungen geändert",
            ["{0} changed to {1}"] = "{0} wurde zu {1} geändert",
            ["DNS test hostname"] = "DNS-Testhostname",
            ["Internet ping targets"] = "Internet-Pingziele",
            ["Web connectivity URL"] = "URL für die Webverbindungsprüfung",
            ["Ping timeout"] = "Ping-Zeitlimit",
            ["Stability samples"] = "Stabilitätsmessungen",
            ["Packet-loss warning"] = "Paketverlustwarnung",
            ["Latency warning"] = "Latenzwarnung",
            ["Run diagnostic on launch"] = "Diagnose beim Start ausführen",
            ["Save diagnostic history"] = "Diagnoseverlauf speichern",
            ["Computer name in exports"] = "Computername in Exporten",
            ["Menu language"] = "Menüsprache",
            ["Enabled"] = "Aktiviert",
            ["Disabled"] = "Deaktiviert",
            ["German"] = "Deutsch",
            ["English"] = "Englisch",
            ["Speed test cancelled. No result was saved."] = "Speedtest abgebrochen. Es wurde kein Ergebnis gespeichert.",
            ["NetCheck could not finish the speed test. Try again."] = "NetCheck konnte den Speedtest nicht abschließen. Versuchen Sie es erneut.",
            ["The speed-test service could not be reached. Check the connection and try again."] = "Der Speedtest-Dienst war nicht erreichbar. Prüfen Sie die Verbindung und versuchen Sie es erneut.",
            ["The speed test timed out. The connection may be too slow or unstable."] = "Der Speedtest hat das Zeitlimit überschritten. Die Verbindung ist möglicherweise zu langsam oder instabil.",
            ["The speed-test service returned an unexpected response. A sign-in page or network filter may be interfering."] = "Der Speedtest-Dienst hat eine unerwartete Antwort geliefert. Möglicherweise stören eine Anmeldeseite oder ein Netzwerkfilter.",
            ["An unexpected error interrupted the speed test. No result was saved."] = "Ein unerwarteter Fehler hat den Speedtest unterbrochen. Es wurde kein Ergebnis gespeichert.",
            ...
            ["NetCheck could not load the saved local history."] = "NetCheck konnte den gespeicherten lokalen Verlauf nicht laden.",
            ...
            ["Clear local history?"] = "Lokalen Verlauf löschen?",
            ["This permanently removes diagnostics, speed tests, and configuration changes saved by NetCheck on this computer."] = "Dadurch werden alle von NetCheck auf diesem Computer gespeicherten Diagnosen, Speedtests und Konfigurationsänderungen dauerhaft gelöscht.",
            ...
            ["MONITORING"] = "MONITORING",
            ["{0} monitoring session"] = "Monitoring-Sitzung · {0}",
            ["{0} availability · {1} outages · {2}"] = "{0} Verfügbarkeit · {1} Ausfälle · {2}",
            ["Standard"] = "Standard",
            ["Gaming"] = "Gaming",
            ["Streaming"] = "Streaming",
            ...
            ["Ready to monitor."] = "Bereit für das Monitoring.",
            ["Updates are checked only when you request it."] = "Updates werden nur auf Ihre Anforderung geprüft.",
            ["Online"] = "Online",
            ["Degraded"] = "Beeinträchtigt",
            ["Offline"] = "Offline",
            ["Waiting"] = "Warten",
            ["The current checks are healthy."] = "Die aktuellen Prüfungen sind unauffällig.",
            ["The connection works, but quality is below this profile's thresholds."] = "Die Verbindung funktioniert, ihre Qualität unterschreitet jedoch die Grenzwerte dieses Profils.",
            ["No usable internet path is currently responding."] = "Derzeit antwortet kein nutzbarer Internetpfad.",
            ["Start monitoring to collect live quality data."] = "Starten Sie das Monitoring, um Live-Qualitätsdaten zu erfassen.",
            ["available"] = "verfügbar",
            ["unavailable"] = "nicht verfügbar",
            ["supported"] = "unterstützt",
            ["not supported"] = "nicht unterstützt",
            ["Driver version unavailable"] = "Treiberversion nicht verfügbar",
            ["Driver {0}"] = "Treiber {0}",
            ["IPv4 {0} · IPv6 {1}"] = "IPv4 {0} · IPv6 {1}",
            ["No connected Wi-Fi interface"] = "Keine verbundene WLAN-Schnittstelle",
            ["{0} · {1}% · channel {2} · {3}"] = "{0} · {1}% · Kanal {2} · {3}",
            ["Receive {0} Mbit/s · transmit {1} Mbit/s · {2}"] = "Empfang {0} Mbit/s · Senden {1} Mbit/s · {2}",
            ["No VPN adapter detected"] = "Kein VPN-Adapter erkannt",
            ["Domain {0} · Private {1} · Public {2}"] = "Domäne {0} · Privat {1} · Öffentlich {2}",
            ["on"] = "ein",
            ["off"] = "aus",
            ["Route unavailable"] = "Route nicht verfügbar",
            ["Better than your local baseline"] = "Besser als Ihre lokale Baseline",
            ["Worse than your local baseline"] = "Schlechter als Ihre lokale Baseline",
            ["Similar to your local baseline"] = "Ähnlich wie Ihre lokale Baseline",
            ["No earlier baseline for this profile"] = "Keine frühere Baseline für dieses Profil",
            ["A baseline appears after another session with this profile."] = "Nach einer weiteren Sitzung mit diesem Profil wird eine Baseline angezeigt.",
            ["Compared with {0} sessions: latency {1}; packet loss {2}; availability {3}."] = "Verglichen mit {0} Sitzungen: Latenz {1}; Paketverlust {2}; Verfügbarkeit {3}.",
            ["Monitoring is running. You can change pages without interrupting it."] = "Das Monitoring läuft. Sie können die Seite wechseln, ohne es zu unterbrechen.",
            ["Monitoring stopped. The partial session was saved safely."] = "Das Monitoring wurde beendet. Die Teilsitzung wurde sicher gespeichert.",
            ["Monitoring completed and was saved to local history."] = "Das Monitoring wurde abgeschlossen und im lokalen Verlauf gespeichert.",
            ["Monitoring could not continue. Completed checks were kept when possible."] = "Das Monitoring konnte nicht fortgesetzt werden. Abgeschlossene Prüfungen wurden soweit möglich beibehalten.",
            ["Monitoring error"] = "Monitoring-Fehler",
            ["Connection lost"] = "Verbindung ausgefallen",
            ["Connection restored"] = "Verbindung wiederhergestellt",
            ["NetCheck detected an outage at {0}."] = "NetCheck hat um {0} einen Ausfall erkannt.",
            ["Connectivity returned at {0}."] = "Die Verbindung wurde um {0} wiederhergestellt.",
            ["Monitoring started"] = "Monitoring gestartet",
            ["Monitoring completed"] = "Monitoring abgeschlossen",
            ["Monitoring stopped"] = "Monitoring beendet",
            ["Quality degraded"] = "Qualität beeinträchtigt",
            ["Quality recovered"] = "Qualität wiederhergestellt",
            ["Network adapter changed"] = "Netzwerkadapter geändert",
            ["Gateway changed"] = "Gateway geändert",
            ["A check failed without stopping monitoring"] = "Eine Prüfung ist fehlgeschlagen, ohne das Monitoring zu beenden",
            ["Duration: {0}"] = "Dauer: {0}",
            ["{0} · event {1}"] = "{0} · Ereignis {1}",
            ["Windows recorded a related network event."] = "Windows hat ein zugehöriges Netzwerkereignis protokolliert.",
            ["Create anonymized support bundle"] = "Anonymisiertes Supportpaket erstellen",
            ["ZIP archive (*.zip)"] = "ZIP-Archiv (*.zip)",
            ["Support bundle created"] = "Supportpaket erstellt",
            ["The anonymized support bundle was saved to:\n{0}"] = "Das anonymisierte Supportpaket wurde hier gespeichert:\n{0}",
            ["Checking the official GitHub release…"] = "Offizielles GitHub-Release wird geprüft…",
            ["Version {0} is available with both ZIP and SHA-256 assets."] = "Version {0} ist mit ZIP- und SHA-256-Datei verfügbar.",
            ["Version {0} is available, but its release asset pair is incomplete."] = "Version {0} ist verfügbar, aber das Release-Dateipaar ist unvollständig.",
            ["NetCheck {0} is up to date."] = "NetCheck {0} ist aktuell.",
            ["This permanently removes diagnostics, speed tests, monitoring sessions, and configuration changes saved by NetCheck on this computer."] = "Dadurch werden die auf diesem Computer von NetCheck gespeicherten Diagnosen, Speedtests, Monitoring-Sitzungen und Konfigurationsänderungen dauerhaft entfernt.",
